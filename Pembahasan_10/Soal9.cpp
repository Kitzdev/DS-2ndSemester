...
class Tree
{
    ...
    */
    void DeleteNode(node* root, int data, int type)
    {
        node* tempNode = root;
        ...
        if(root != NULL)
        {
            ...
            } else  //Third case: node with two child
            {
                if(type == 3)   //Type 3: deletion by merging
                {
                    nodeChanger = root -> leftLink;
                ...
                } else if(type == 4)
                {
                    ...
                    while(RMIP -> rightLink != NULL)
                    {
                        ...
                        {
                            beforeRMIP = beforeRMIP -> rightLink;
                        }
...
int main()
{
    ...
    int dataContainer;
    int userAnswerI;
    int number[16] = {50, 25, 75, 10, 35, 60, 85, 30, 40, 55, 65, 28, 63, 68, 27, 29};
    ...
    do
    {
        ...
        }else if(userAnswerI == 3)
        {
            ...
            theTree.DeleteNode(theTree.root, dataContainer, userAnswerI);
